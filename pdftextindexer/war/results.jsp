...
<%@page import="org.apache.commons.lang.StringEscapeUtils"%><p>ERROR opening the Index - contact sysadmin!</p>
...
<%
       if (error == false) {                                           //did we open the index?
                ...
                Analyzer analyzer = new org.apache.lucene.analysis.snowball.SnowballAnalyzer("English", StopAnalyzer.ENGLISH_STOP_WORDS);           //construct our usual analyzer
                try {
